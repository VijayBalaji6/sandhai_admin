...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1336: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1337: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1344: x0 => x0.decode(),
      ...
      _1355: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1356: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1358: () => globalThis.firebase_core.getApp(),
      _1359: (x0,x1,x2) => globalThis.firebase_core.registerVersion(x0,x1,x2),
      _1379: () => globalThis.firebase_core.SDK_VERSION,
      _1385: x0 => x0.apiKey,
      _1387: x0 => x0.authDomain,
      _1389: x0 => x0.databaseURL,
      _1391: x0 => x0.projectId,
      _1393: x0 => x0.storageBucket,
      _1395: x0 => x0.messagingSenderId,
      _1397: x0 => x0.measurementId,
      _1399: x0 => x0.appId,
      _1401: x0 => x0.name,
      _1402: x0 => x0.options,
      _1403: (x0,x1) => x0.debug(x1),
      _1404: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1404(f,arguments.length,x0) }),
      _1405: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports._1405(f,arguments.length,x0,x1) }),
      _1406: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1407: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1408: (x0,x1) => x0.createScriptURL(x1),
      _1409: (x0,x1,x2) => x0.createScript(x1,x2),
      ...
      _1429: x0 => new WeakRef(x0),
      _1430: x0 => x0.deref(),
      _1437: () => globalThis.WeakRef,
      ...
      _1639: (x0,x1) => x0.close(x1),
      _1640: x0 => x0.close(),
      _1647: () => new FileReader(),
      _1648: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1649: x0 => new BroadcastChannel(x0),
      _1650: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1650(f,arguments.length,x0) }),
      _1651: (x0,x1) => x0.postMessage(x1),
      _1652: x0 => x0.close(),
      _1653: () => new AbortController(),
      _1654: x0 => x0.abort(),
      _1655: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1656: (x0,x1) => globalThis.fetch(x0,x1),
      _1657: (x0,x1) => x0.get(x1),
      _1658: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1658(f,arguments.length,x0,x1,x2) }),
      _1659: (x0,x1) => x0.forEach(x1),
      _1660: x0 => x0.getReader(),
      _1661: x0 => x0.cancel(),
      _1662: x0 => x0.read(),
      _1663: (x0,x1) => x0.key(x1),
      _1664: (x0,x1) => x0.item(x1),
      _1665: x0 => x0.trustedTypes,
      _1666: (x0,x1) => { x0.text = x1 },
      _1667: o => o instanceof Array,
      _1668: (a, i) => a.push(i),
      _1672: a => a.pop(),
      _1673: (a, i) => a.splice(i, 1),
      _1675: (a, s, e) => a.slice(s, e),
      _1677: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1678: a => a.length,
      _1680: (a, i) => a[i],
      _1681: (a, i, v) => a[i] = v,
      _1683: o => {
      ...
      _1684: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1686: o => o instanceof Uint8Array,
      _1687: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1688: o => o instanceof Int8Array,
      _1689: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1690: o => o instanceof Uint8ClampedArray,
      _1691: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1692: o => o instanceof Uint16Array,
      _1693: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1694: o => o instanceof Int16Array,
      _1695: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1696: o => o instanceof Uint32Array,
      _1697: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1698: o => o instanceof Int32Array,
      _1699: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1701: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1702: o => o instanceof Float32Array,
      _1703: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1704: o => o instanceof Float64Array,
      _1705: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1706: (t, s) => t.set(s),
      _1707: l => new DataView(new ArrayBuffer(l)),
      _1708: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1710: o => o.buffer,
      _1711: o => o.byteOffset,
      _1712: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1713: (b, o) => new DataView(b, o),
      _1714: (b, o, l) => new DataView(b, o, l),
      _1715: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1716: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1717: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1718: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1719: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1720: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1721: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1722: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1723: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1724: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1725: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1726: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1729: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1730: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1731: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1732: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1733: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1734: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1735: Function.prototype.call.bind(Number.prototype.toString),
      _1736: Function.prototype.call.bind(BigInt.prototype.toString),
      _1737: Function.prototype.call.bind(Number.prototype.toString),
      _1738: (d, digits) => d.toFixed(digits),
      _1750: () => globalThis.document,
      _1756: (x0,x1) => { x0.height = x1 },
      _1758: (x0,x1) => { x0.width = x1 },
      _1760: (x0,x1) => { x0.pointerEvents = x1 },
      _1769: x0 => x0.style,
      _1772: x0 => x0.src,
      _1773: (x0,x1) => { x0.src = x1 },
      _1774: x0 => x0.naturalWidth,
      _1775: x0 => x0.naturalHeight,
      _1791: x0 => x0.status,
      _1792: (x0,x1) => { x0.responseType = x1 },
      _1794: x0 => x0.response,
      _1843: (x0,x1) => { x0.responseType = x1 },
      _1844: x0 => x0.response,
      _1933: (x0,x1) => { x0.oncancel = x1 },
      _1939: (x0,x1) => { x0.onchange = x1 },
      _1979: (x0,x1) => { x0.onerror = x1 },
      _2849: (x0,x1) => { x0.accept = x1 },
      _2863: x0 => x0.files,
      _2889: (x0,x1) => { x0.multiple = x1 },
      _2907: (x0,x1) => { x0.type = x1 },
      _3159: (x0,x1) => { x0.type = x1 },
      _3167: (x0,x1) => { x0.crossOrigin = x1 },
      _3169: (x0,x1) => { x0.text = x1 },
      _3625: () => globalThis.window,
      _3668: x0 => x0.location,
      _3687: x0 => x0.navigator,
      _3949: x0 => x0.trustedTypes,
      _3950: x0 => x0.sessionStorage,
      _3951: x0 => x0.localStorage,
      _3959: x0 => x0.href,
      _4076: x0 => x0.userAgent,
      _4077: x0 => x0.vendor,
      _4082: x0 => x0.onLine,
      _4127: x0 => x0.data,
      _4174: (x0,x1) => { x0.onmessage = x1 },
      _4281: x0 => x0.length,
      _4498: x0 => x0.readyState,
      _4511: (x0,x1) => { x0.binaryType = x1 },
      _4514: x0 => x0.code,
      _4515: x0 => x0.reason,
      _6182: x0 => x0.type,
      _6183: x0 => x0.target,
      ...
      _8237: x0 => x0.type,
      _8244: x0 => x0.name,
      _8245: x0 => x0.lastModified,
      _8250: x0 => x0.length,
      _8256: x0 => x0.result,
      _8753: x0 => x0.url,
      _8755: x0 => x0.status,
      _8757: x0 => x0.statusText,
      _8758: x0 => x0.headers,
      _8759: x0 => x0.body,
      _12387: x0 => x0.name,
      _13103: () => globalThis.console,
